...
public class TransfersAPIHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
	...
	public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
		...
		try {
			myString = getAccountTransactionList();
		} catch (Exception e) {
	...
	*/	
	...
	private String getAccountTransactionList(){
		...
		String inputUrl ="https://apisandbox.openbankproject.com/obp/v3.0.0/banks/"+bankId+"/accounts/"+accountNumber+"/owner/transactions";
		...
		try {
			accountTransactionList = createConnectionAndInvokeGETREST(inputUrl,inputJSON,headerInfo);
		} catch (IOException e) {
			accountTransactionList = "failedToken";
			e.printStackTrace();
		}
